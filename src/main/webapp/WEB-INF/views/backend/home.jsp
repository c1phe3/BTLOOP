                                    ...
                                    <table class="table select-table">
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          <td>
                                            <div class="d-flex ">
                                              <img src="${classpath}/backend/assets/images/faces/face1.jpg" alt="">
                                              <div>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <div class="d-flex">
                                              <img src="${classpath}/backend/assets/images/faces/face2.jpg" alt="">
                                              <div>
                                                <h6>Laura Brooks</h6>
                                                <p>Head admin</p>
                                              </div>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <div class="d-flex">
                                              <img src="${classpath}/backend/assets/images/faces/face3.jpg" alt="">
                                              <div>
                                                <h6>Wayne Murphy</h6>
                                                <p>Head admin</p>
                                              </div>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <div class="d-flex">
                                              <img src="${classpath}/backend/assets/images/faces/face4.jpg" alt="">
                                              <div>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <div class="d-flex">
                                              <img src="${classpath}/backend/assets/images/faces/face5.jpg" alt="">
                                              <div>
                            ...
                            <div class="col-md-6 col-lg-6 grid-margin stretch-card">
                              <div class="card card-rounded">
                                <div class="card-body card-rounded">
                                  <h4 class="card-title  card-title-dash">Information Events</h4>
                              ...
                              <div class="card card-rounded">
                                <div class="card-body">
                                  <div class="d-flex align-items-center justify-content-between mb-3">
                                    <h4 class="card-title card-title-dash">Order in process</h4>
                                    ...
                                    <div class="col-lg-12">
                                      ...
                                      <div class="mt-3">
                                        <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                          <div class="d-flex">
                                            <img class="img-sm rounded-10" src="${classpath}/backend/assets/images/faces/face1.jpg" alt="profile">
                                        ...
                                        <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                          <div class="d-flex">
                                            <img class="img-sm rounded-10" src="${classpath}/backend/assets/images/faces/face2.jpg" alt="profile">
                                            <div class="wrapper ms-3">
                                        ...
                                        <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                          <div class="d-flex">
                                            <img class="img-sm rounded-10" src="${classpath}/backend/assets/images/faces/face3.jpg" alt="profile">
                                            <div class="wrapper ms-3">
                                        ...
                                        <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                          <div class="d-flex">
                                            <img class="img-sm rounded-10" src="${classpath}/backend/assets/images/faces/face4.jpg" alt="profile">
                                            <div class="wrapper ms-3">
                                        ...
                                        <div class="wrapper d-flex align-items-center justify-content-between pt-2">
                                          <div class="d-flex">
                                            <img class="img-sm rounded-10" src="${classpath}/backend/assets/images/faces/face5.jpg" alt="profile">
                                            <div class="wrapper ms-3">
